...
const $$Casas = createComponent(async ($$result, $$props, $$slots) => {
  const { data: terrenos, error } = await supabase.from("Terrenos").select("id, titulo, descripcion, precio, imagenes, medidas, ubicacion, tipo, fecha").eq("tipo", "casa").order("fecha", { ascending: false });
...
}, "C:/Users/Oguzm/OneDrive/Documentos/GitHub/RegistrarTerrenos/src/pages/TipoTerreno/Casas.astro", void 0);

const $$file = "C:/Users/Oguzm/OneDrive/Documentos/GitHub/RegistrarTerrenos/src/pages/TipoTerreno/Casas.astro";
const $$url = "/TipoTerreno/Casas";

...
const $$PropiedadesComerciales = createComponent(async ($$result, $$props, $$slots) => {
  const { data: terrenos, error } = await supabase.from("Terrenos").select("id, titulo, descripcion, precio, imagenes, medidas, ubicacion, tipo, fecha").eq("tipo", "comercial").order("fecha", { ascending: false });
...
</p> </div> ${error && renderTemplate`<p class="text-red-500 text-center">Error al cargar propiedades comerciales</p>`} <!-- Listado --> <div class="grid gap-10 sm:gap-12 md:gap-14 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-3 mx-auto px-4 md:px-8 mb-12"> ${Array.isArray(terrenos) && terrenos.map((terreno) => renderTemplate`${renderComponent($$result2, "CardMostrarTerreno", $$CardMostrarTerreno, { "id": terreno.id, "imagenes": terreno.imagenes, "titulo": terreno.titulo, "descripcion": terreno.descripcion, "precio": terreno.precio, "textBoton": "Me interesa", "hrefBoton": "#", "medidas": terreno.medidas, "ubicacion": terreno.ubicacion, "fecha": terreno.fecha, "tipo": terreno.tipo })}`)} </div> ${renderComponent($$result2, "Footer", $$Footer, {})} </section> ` })}`;
}, "C:/Users/Oguzm/OneDrive/Documentos/GitHub/RegistrarTerrenos/src/pages/TipoTerreno/PropiedadesComerciales.astro", void 0);

const $$file = "C:/Users/Oguzm/OneDrive/Documentos/GitHub/RegistrarTerrenos/src/pages/TipoTerreno/PropiedadesComerciales.astro";
const $$url = "/TipoTerreno/PropiedadesComerciales";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$PropiedadesComerciales,
  file: $$file,
  prerender,
  url: $$url
